...
//     // Hard coded sensor data for testing
//     SensorData lightsensordata;
//     lightsensordata.lux = 100;
//     SensorData soilmoisturedata;
//     soilmoisturedata.moisture = 1000;
//     SensorData tempHumidData;
//     tempHumidData.temperature = 25.0;
//     tempHumidData.humidity = 50.0;
